    ...
    switch (index) {
      ...
      case 1:
        page = const CategoryScreen(
          ...
          articles: [
            Article(title: 'بهترین غذاهای خشک برای گربه', summary: '', readingTime: '۸ دقیقه', icon: '', content: ''),
            Article(title: 'غذاهای خانگی مجاز برای گربه', summary: '', readingTime: '۶ دقیقه', icon: '', content: ''),
            Article(title: 'چه غذاهایی برای گربه سمی است؟', summary: '', readingTime: '۵ دقیقه', icon: '', content: ''),
            Article(title: 'برنامه غذایی بچه گربه', summary: '', readingTime: '۷ دقیقه', icon: '', content: ''),
            Article(title: 'آب و اهمیت هیدراتاسیون', summary: '', readingTime: '۴ دقیقه', icon: '', content: ''),
          ],
        );
      case 2:
        page = const CategoryScreen(
          ...
          articles: [
            Article(title: 'واکسن\u200Cهای ضروری گربه', summary: '', readingTime: '۶ دقیقه', icon: '', content: ''),
            Article(title: 'بیماری\u200Cهای شایع در گربه\u200Cها', summary: '', readingTime: '۱۰ دقیقه', icon: '', content: ''),
            Article(title: 'اهمیت معاینه سالانه دامپزشکی', summary: '', readingTime: '۵ دقیقه', icon: '', content: ''),
            Article(title: 'انگل\u200Cها و راههای پیشگیری', summary: '', readingTime: '۷ دقیقه', icon: '', content: ''),
            Article(title: 'سلامت دهان و دندان گربه', summary: '', readingTime: '۵ دقیقه', icon: '', content: ''),
          ],
        );
      case 3:
        page = const CategoryScreen(
          ...
          featuredArticle: Article(
            ...
            readingTime: '۸ دقیقه',
            icon: 'training',
            content: 'بسیاری تصور می\u200Cکنند گربه\u200Cها آموزش\u200Cپذیر نیستند، اما این باور اشتباه است. گربه\u200Cها با روش\u200Cهای صحیح و تشویقی به خوبی آموزش می\u200Cبینند.\n\nکلید موفقیت در آموزش گربه، صبر و استفاده از پاداش\u200Cهای غذایی است. جلسات آموزشی را کوتاه نگه دارید و هرگز از تنبیه استفاده نکنید.\n\nآموزش دستشویی، نخ چنگ زدن به مبل، آمدن به سمت شما و حتی نشستن و غلت زدن از جمله مواردی هستند که می\u200Cتوانید به گربه خود آموزش دهید.',
          ),
          articles: [
            Article(title: 'آموزش دستشویی به بچه گربه', summary: '', readingTime: '۶ دقیقه', icon: '', content: ''),
            Article(title: 'چگونه گربه را از چنگ زدن به مبل بازداریم', summary: '', readingTime: '۵ دقیقه', icon: '', content: ''),
            Article(title: 'ترفندهای جذاب برای آموزش گربه', summary: '', readingTime: '۸ دقیقه', icon: '', content: ''),
            Article(title: 'رفع رفتار گاز گرفتن در گربه', summary: '', readingTime: '۵ دقیقه', icon: '', content: ''),
            Article(title: 'آموزش فرمان\u200Cهای ساده به گربه', summary: '', readingTime: '۷ دقیقه', icon: '', content: ''),
          ],
        );
      case 4:
        page = const CategoryScreen(
          ...
          articles: [
            Article(title: 'اسباب\u200Cبازی\u200Cهای دست\u200Cساز برای گربه', summary: '', readingTime: '۶ دقیقه', icon: '', content: ''),
            Article(title: 'بازی\u200Cهای تعاملی با گربه', summary: '', readingTime: '۵ دقیقه', icon: '', content: ''),
            Article(title: 'چگونه یک درخت گربه خانگی بسازیم', summary: '', readingTime: '۱۰ دقیقه', icon: '', content: ''),
            Article(title: 'اسباب\u200Cبازی\u200Cهای پازلی و هوشی', summary: '', readingTime: '۷ دقیقه', icon: '', content: ''),
            Article(title: 'بهترین اپلیکیشن\u200Cهای سرگرمی گربه', summary: '', readingTime: '۴ دقیقه', icon: '', content: ''),
          ],
        );
      default:
        page = const CategoryScreen(
          ...
          articles: [
            Article(title: 'واکسن\u200Cهای سه\u200Cگانه و چهارگانه', summary: '', readingTime: '۷ دقیقه', icon: '', content: ''),
            Article(title: 'برنامه واکسیناسیون بچه گربه', summary: '', readingTime: '۶ دقیقه', icon: '', content: ''),
            Article(title: 'عوارض جانبی واکسن در گربه', summary: '', readingTime: '۵ دقیقه', icon: '', content: ''),
            Article(title: 'ضدعفونی و انگل\u200Cزدایی', summary: '', readingTime: '۶ دقیقه', icon: '', content: ''),
            Article(title: 'مراقبت\u200Cهای بعد از جراحی عقیم\u200Cسازی', summary: '', readingTime: '۸ دقیقه', icon: '', content: ''),
          ],
        );
    }
