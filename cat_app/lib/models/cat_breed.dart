...
const List<CatBreed> catBreeds = [
  ...
  CatBreed(
    ...
    description:
        ...
        'شیطون، بازیگوش و به\u200Cشدت اجتماعی دارند و بیشتر شبیه سگ رفتار '
  ...
  CatBreed(
    ...
    description:
        ...
        'نیمه\u200Cبلند و ظاهری بسیار ظریف و چشم\u200Cنواز است. باهوش، بازیگوش و '
  ...
  CatBreed(
    ...
    description:
        'گربه خانگی مو\u200Cکوتاه رایج\u200Cترین گربه در ایران است که '
  ...
  CatBreed(
    ...
    description:
        ...
        'شخصیتی آرام، ظریف و وفادار دارند و محیط ساکت را ترجیح می\u200Cدهند.',
    descriptionEn:
