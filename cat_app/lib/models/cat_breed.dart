...
const List<Map<String, String>> catFacts = [
  {
    'title': 'Ancient Companions',
    'description':
        'Cats were domesticated around 7500 BCE in the Near East. They have '
            'been living alongside humans for nearly 10,000 years.',
  },
  {
    'title': 'Purring Mystery',
    'description':
        'Cats purr at a frequency of 25-150 Hz, which is known to promote '
            'healing of bones and tissues. They purr not only when happy but '
            'also when stressed or in pain as a self-soothing mechanism.',
  },
  {
    'title': 'Sleep Champions',
    'description':
        'Cats sleep for an average of 12-16 hours per day, which means a '
            'cat spends about 70% of its life sleeping.',
  },
  {
    'title': 'Amazing Jumpers',
    'description':
        'A cat can jump up to 6 times its body length in a single bound. '
            'This is due to powerful muscles in their back legs.',
  },
  {
    'title': 'Unique Nose Prints',
    'description':
        'Just like human fingerprints, a cat\'s nose print is unique to '
            'each individual cat. No two cats have the same nose pattern.',
  },
  {
    'title': 'Whisker Magic',
    'description':
        'A cat\'s whiskers are as wide as its body and help them determine '
            'if they can fit through tight spaces. Never trim a cat\'s whiskers!',
  },
  {
    'title': 'Night Vision',
    'description':
        'Cats can see in light levels 6 times lower than what a human needs. '
            'Their eyes have a reflective layer called tapetum lucidum that '
            'makes their eyes glow in the dark.',
  },
  {
    'title': 'Vocal Range',
    'description':
        'Cats can make over 100 different vocal sounds, while dogs can only '
            'make about 10. They reserve their meows specifically for '
            'communicating with humans.',
  },
  {
    'title': 'World\'s Richest Cat',
    'description':
        'A cat named Blackie inherited \$12.5 million from his British '
            'owner in 1988, making him the richest cat in history.',
  },
  {
    'title': 'Cat Walk',
    'description':
        'Cats walk by moving both right feet first, then both left feet. '
            'Camels and giraffes are the only other animals that walk this way. '
            'This gait helps them move silently and leave minimal tracks.',
  },
];
